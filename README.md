...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/weave-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/weave-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/weave-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/weave-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/weave-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/weave-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/weave/badges/version.svg)](https://anaconda.org/conda-forge/weave)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/weave/badges/downloads.svg)](https://anaconda.org/conda-forge/weave)
